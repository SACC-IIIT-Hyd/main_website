          ...
          {loading ? (
            ...
            <>
              <p className="panel-description">
                Select a community to manage its details and verify join
                requests.
              </p>
    ...
    <div className="community-management">
      ...
      <div className="form-section">
        ...
        <p className="section-description">
          Enter an identifier to check if any alumnus has applied to join this
          community with that identifier.
        </p>
              ...
              {verificationResult.found ? (
                ...
                <div className="result-content">
                  ...
                  <div className="result-details">
                    ...
                    <p>
                      No join request found with the provided identifier for
                      this community.
                    </p>
                  </div>
                </div>
